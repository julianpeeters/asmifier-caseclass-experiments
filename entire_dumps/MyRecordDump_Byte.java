...
[0m[[32msuccess[0m] [0mTotal time: 0 s, completed Jun 21, 2013 12:34:42 AM[0m
[0m[[0minfo[0m] [0mLoading global plugins from /home/julianpeeters/.sbt/plugins[0m
[0m[[0minfo[0m] [0mSet current project to default-22f0e6 (in build file:/home/julianpeeters/asmifier-caseclass-experiments/)[0m
...
[0m[[32msuccess[0m] [0mTotal time: 13 s, completed Jun 21, 2013 12:35:00 AM[0m
import java.util.*;
...
{
mv = cw.visitMethod(ACC_PRIVATE + ACC_FINAL, "gd1$1", "(B)Z", null, null);
mv.visitCode();
mv.visitVarInsn(ILOAD, 1);
mv.visitVarInsn(ALOAD, 0);
mv.visitMethodInsn(INVOKEVIRTUAL, "MyRecord", "x", "()B");
