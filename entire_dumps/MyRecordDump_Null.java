...
[0m[[32msuccess[0m] [0mTotal time: 0 s, completed Jun 21, 2013 10:19:05 PM[0m
[0m[[0minfo[0m] [0mLoading global plugins from /home/julianpeeters/.sbt/plugins[0m
[0m[[0minfo[0m] [0mSet current project to default-22f0e6 (in build file:/home/julianpeeters/asmifier-caseclass-experiments/)[0m
...
[0m[[32msuccess[0m] [0mTotal time: 15 s, completed Jun 21, 2013 10:19:26 PM[0m
import java.util.*;
...
{
mv = cw.visitMethod(ACC_PUBLIC + ACC_FINAL + ACC_STATIC, "andThen", "(Lscala/Function1;)Lscala/Function1;", "<A:Ljava/lang/Object;>(Lscala/Function1<LMyRecord;TA;>;)Lscala/Function1<Lscala/runtime/Null$;TA;>;", null);
mv.visitCode();
...
mv.visitMethodInsn(INVOKESPECIAL, "MyRecord", "gd1$1", "(Lscala/runtime/Null$;)Z");
Label l2 = new Label();
...
{
mv = cw.visitMethod(ACC_PRIVATE + ACC_FINAL, "gd1$1", "(Lscala/runtime/Null$;)Z", null, null);
mv.visitCode();
mv.visitVarInsn(ALOAD, 1);
mv.visitInsn(POP);
mv.visitInsn(ACONST_NULL);
