...
[0m[[32msuccess[0m] [0mTotal time: 0 s, completed Dec 21, 2014 3:00:49 PM[0m
Loading /usr/share/sbt/bin/sbt-launch-lib.bash
[0m[[0minfo[0m] [0mLoading global plugins from /home/julian/.sbt/0.13/plugins[0m
[0m[[0minfo[0m] [0mLoading project definition from /home/julian/Dropbox/asmifier-caseclass-experiments/project[0m
[0m[[0minfo[0m] [0mSet current project to asmifier-caseclass-experiments (in build file:/home/julian/Dropbox/asmifier-caseclass-experiments/)[0m
...
[0m[[33mwarn[0m] [0m/home/julian/Dropbox/asmifier-caseclass-experiments/src/main/scala/models/MyRecord_Unit.scala:2: comparing values of types Unit and Unit using `==' will always yield true[0m
...
[0m[[32msuccess[0m] [0mTotal time: 22 s, completed Dec 21, 2014 3:01:19 PM[0m
package asm.models;
import java.util.*;
...
{
mv = cw.visitMethod(ACC_PUBLIC + ACC_STATIC, "unapply", "(Lmodels/MyRecord;)Lscala/Option;", "(Lmodels/MyRecord;)Lscala/Option<Lscala/Tuple3<Lscala/runtime/BoxedUnit;Lscala/runtime/Nothing$;Lscala/runtime/BoxedUnit;>;>;", null);
mv.visitCode();
...
{
mv = cw.visitMethod(ACC_PUBLIC + ACC_STATIC, "apply", "(Lscala/runtime/BoxedUnit;Lscala/runtime/Nothing$;Lscala/runtime/BoxedUnit;)Lmodels/MyRecord;", null, null);
mv.visitCode();
mv.visitFieldInsn(GETSTATIC, "models/MyRecord$", "MODULE$", "Lmodels/MyRecord$;");
mv.visitVarInsn(ALOAD, 0);
mv.visitVarInsn(ALOAD, 1);
mv.visitVarInsn(ALOAD, 2);
mv.visitMethodInsn(INVOKEVIRTUAL, "models/MyRecord$", "apply", "(Lscala/runtime/BoxedUnit;Lscala/runtime/Nothing$;Lscala/runtime/BoxedUnit;)Lmodels/MyRecord;");
mv.visitInsn(ARETURN);
mv.visitMaxs(4, 3);
mv.visitEnd();
}
{
mv = cw.visitMethod(ACC_PUBLIC + ACC_STATIC, "tupled", "()Lscala/Function1;", "()Lscala/Function1<Lscala/Tuple3<Lscala/runtime/BoxedUnit;Lscala/runtime/Nothing$;Lscala/runtime/BoxedUnit;>;Lmodels/MyRecord;>;", null);
mv.visitCode();
mv.visitFieldInsn(GETSTATIC, "models/MyRecord$", "MODULE$", "Lmodels/MyRecord$;");
...
{
mv = cw.visitMethod(ACC_PUBLIC + ACC_STATIC, "curried", "()Lscala/Function1;", "()Lscala/Function1<Lscala/runtime/BoxedUnit;Lscala/Function1<Lscala/runtime/Nothing$;Lscala/Function1<Lscala/runtime/BoxedUnit;Lmodels/MyRecord;>;>;>;", null);
mv.visitCode();
mv.visitFieldInsn(GETSTATIC, "models/MyRecord$", "MODULE$", "Lmodels/MyRecord$;");
...
{
mv = cw.visitMethod(ACC_PUBLIC, "x", "()V", null, null);
mv.visitCode();
mv.visitInsn(RETURN);
mv.visitMaxs(0, 1);
mv.visitEnd();
...
{
mv = cw.visitMethod(ACC_PUBLIC, "copy$default$1", "()V", null, null);
mv.visitCode();
mv.visitVarInsn(ALOAD, 0);
...
mv.visitFieldInsn(GETSTATIC, "scala/runtime/BoxedUnit", "UNIT", "Lscala/runtime/BoxedUnit;");
mv.visitLabel(l4);
mv.visitFrame(Opcodes.F_SAME1, 0, null, 1, new Object[] {"scala/runtime/BoxedUnit"});
mv.visitInsn(ARETURN);
mv.visitMaxs(3, 3);
mv.visitEnd();
}
...
mv.visitLabel(l4);
mv.visitFrame(Opcodes.F_FULL, 6, new Object[] {"models/MyRecord", "java/lang/Object", "java/lang/Object", Opcodes.INTEGER, "models/MyRecord", "scala/runtime/BoxedUnit"}, 1, new Object[] {"scala/runtime/BoxedUnit"});
mv.visitVarInsn(ALOAD, 5);
