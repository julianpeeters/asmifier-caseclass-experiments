...
[0m[[32msuccess[0m] [0mTotal time: 0 s, completed Dec 21, 2014 2:53:59 PM[0m
Loading /usr/share/sbt/bin/sbt-launch-lib.bash
[0m[[0minfo[0m] [0mLoading global plugins from /home/julian/.sbt/0.13/plugins[0m
[0m[[0minfo[0m] [0mLoading project definition from /home/julian/Dropbox/asmifier-caseclass-experiments/project[0m
[0m[[0minfo[0m] [0mSet current project to asmifier-caseclass-experiments (in build file:/home/julian/Dropbox/asmifier-caseclass-experiments/)[0m
...
[0m[[32msuccess[0m] [0mTotal time: 22 s, completed Dec 21, 2014 2:54:29 PM[0m
package asm.models;
import java.util.*;
...
{
fv = cw.visitField(ACC_PRIVATE + ACC_FINAL, "z", "J", null, null);
fv.visitEnd();
}
{
...
{
mv = cw.visitMethod(ACC_PUBLIC + ACC_STATIC, "apply", "(JLscala/runtime/Nothing$;J)Lmodels/MyRecord;", null, null);
mv.visitCode();
mv.visitFieldInsn(GETSTATIC, "models/MyRecord$", "MODULE$", "Lmodels/MyRecord$;");
mv.visitVarInsn(LLOAD, 0);
mv.visitVarInsn(ALOAD, 2);
mv.visitVarInsn(LLOAD, 3);
mv.visitMethodInsn(INVOKEVIRTUAL, "models/MyRecord$", "apply", "(JLscala/runtime/Nothing$;J)Lmodels/MyRecord;");
mv.visitInsn(ARETURN);
mv.visitMaxs(6, 5);
mv.visitEnd();
}
...
{
mv = cw.visitMethod(ACC_PUBLIC, "z", "()J", null, null);
mv.visitCode();
mv.visitVarInsn(ALOAD, 0);
mv.visitFieldInsn(GETFIELD, "models/MyRecord", "z", "J");
mv.visitInsn(LRETURN);
mv.visitMaxs(2, 1);
mv.visitEnd();
}
...
mv.visitVarInsn(ALOAD, 0);
mv.visitMethodInsn(INVOKEVIRTUAL, "models/MyRecord", "x", "()J");
mv.visitMethodInsn(INVOKESTATIC, "scala/runtime/Statics", "longHash", "(J)I");
