...
[0m[[32msuccess[0m] [0mTotal time: 0 s, completed Jun 21, 2013 11:36:06 PM[0m
[0m[[0minfo[0m] [0mLoading global plugins from /home/julianpeeters/.sbt/plugins[0m
[0m[[0minfo[0m] [0mSet current project to default-22f0e6 (in build file:/home/julianpeeters/asmifier-caseclass-experiments/)[0m
...
[0m[[33mwarn[0m] [0m/home/julianpeeters/asmifier-caseclass-experiments/MyRecord_Unit.scala:1: comparing values of types Unit and Unit using `==' will always yield true[0m
...
[0m[[32msuccess[0m] [0mTotal time: 17 s, completed Jun 21, 2013 11:36:29 PM[0m
import java.util.*;
...
{
mv = cw.visitMethod(ACC_PUBLIC + ACC_FINAL + ACC_STATIC, "compose", "(Lscala/Function1;)Lscala/Function1;", "<A:Ljava/lang/Object;>(Lscala/Function1<TA;Lscala/runtime/BoxedUnit;>;)Lscala/Function1<TA;LMyRecord;>;", null);
mv.visitCode();
mv.visitFieldInsn(GETSTATIC, "MyRecord$", "MODULE$", "LMyRecord$;");
mv.visitVarInsn(ALOAD, 0);
...
{
mv = cw.visitMethod(ACC_PUBLIC, "copy", "(Lscala/runtime/BoxedUnit;)LMyRecord;", null, null);
mv.visitCode();
...
mv.visitMethodInsn(INVOKESPECIAL, "MyRecord", "gd1$1", "(Lscala/runtime/BoxedUnit;)Z");
Label l2 = new Label();
...
{
mv = cw.visitMethod(ACC_PRIVATE + ACC_FINAL, "gd1$1", "(Lscala/runtime/BoxedUnit;)Z", null, null);
mv.visitCode();
mv.visitVarInsn(ALOAD, 1);
mv.visitFieldInsn(GETSTATIC, "scala/runtime/BoxedUnit", "UNIT", "Lscala/runtime/BoxedUnit;");
mv.visitVarInsn(ASTORE, 2);
