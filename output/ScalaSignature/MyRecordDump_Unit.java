...
[0m[[32msuccess[0m] [0mTotal time: 0 s, completed Dec 21, 2014 4:29:19 PM[0m
Loading /usr/share/sbt/bin/sbt-launch-lib.bash
[0m[[0minfo[0m] [0mLoading global plugins from /home/julian/.sbt/0.13/plugins[0m
[0m[[0minfo[0m] [0mLoading project definition from /home/julian/Dropbox/asmifier-caseclass-experiments/project[0m
[0m[[0minfo[0m] [0mSet current project to asmifier-caseclass-experiments (in build file:/home/julian/Dropbox/asmifier-caseclass-experiments/)[0m
...
[0m[[32msuccess[0m] [0mTotal time: 58 s, completed Dec 21, 2014 4:30:40 PM[0m
package asm.models;
import java.util.*;
...
// ATTRIBUTE ScalaSig
{
mv = cw.visitMethod(ACC_PUBLIC + ACC_STATIC, "unapply", "(Lmodels/MyRecord;)Lscala/Option;", "(Lmodels/MyRecord;)Lscala/Option<Lscala/runtime/BoxedUnit;>;", null);
mv.visitCode();
